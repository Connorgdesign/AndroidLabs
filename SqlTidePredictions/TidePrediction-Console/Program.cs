...
namespace TidePrediction_Console
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string dbPath = currentDir + @"/../../../../SqlTidePredictions/Assets/tides.db3";
            ...
            AddTidePredictionToDb(db, currentDir + @" /../../../../SqlTidePredictions/Assets/florence.xml", "Florence");
            AddTidePredictionToDb(db, currentDir + @"/../../../../SqlTidePredictions/Assets/newport.xml", "Newport");
            AddTidePredictionToDb(db, currentDir + @"/../../../../SqlTidePredictions/Assets/astoria.xml", "Astoria");
        }

        private static void AddTidePredictionToDb(SQLiteConnection db, string file, string city)
        {

            XmlTideFileParser reader = new XmlTideFileParser(File.Open(@file, FileMode.Open));
            List<System.Collections.Generic.IDictionary<string, object>> tideList = reader.TideList;
